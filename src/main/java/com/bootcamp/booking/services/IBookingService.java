...
public interface IBookingService {
    ...
    FlightResponseDTO flightReservation(FlightRequestDTO requestDTO) throws BadRequestException, EmailFormatException, DatesAfterBeforeException, NoDestinationException, PaymentException;
}
